...
MP4 = mp(2,2,2,2,2,2)(C4)

C5 = conv_relu_layers({256},{512,bn=true,dropout=0.4},{3,3})(MP4)

MP5 = mp(2,2,2,2,2,2)(C5)

C6 = conv_relu_layers({512},{1024,bn=true,dropout=0.4},{3,3})(MP5)


UP5 = up(1024,512,2,2,2,2,2,2)(C6)

JT5 = nn.JoinTable(1,4)({C5,UP5})

U5 = conv_relu_layers({1024,down=512},{512,bn=true,dropout=0.4},{3,3})(JT5)

UP4 = up(512,256,2,2,2,2,2,2)(U5)

JT4 = nn.JoinTable(1,4)({C4,UP4})

U4 = conv_relu_layers({512,down=256},{256,bn=true,dropout=0.4},{3,3})(JT4)
...
U2 = conv_relu_layers({128,down=64},{64,bn=true,dropout=0.4},{3,3})(JT2)

UP1 = up(64,32,2,2,2,2,2,2)(U2)

JT1 = nn.JoinTable(1,4)({C1,UP1})

U1 = conv_relu_layers({64,down=32},{32,bn=true,dropout=0.4},{4,3})(JT1)
