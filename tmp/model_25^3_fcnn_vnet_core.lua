...
convGpu2:add(mp2);
convGpu2 = wrapGPU(convGpu2,2)
local cat2 = nn.ConcatTable();
cat2:add(convGpu2);
cat2:add(nn.Identity());
convGpu1_2:get(1):add(cat2);
...
convGpu3:get(1):add(join1);
convGpu3:get(1):add(deConv2);
--1x256x3x15x15  =x2
...
convGpu2_2:get(1):add(join2);
convGpu2_2:get(1):add(deConv3);
--1x128x3x31x31 =x2
...
convGpu2:get(1):add(join3);
convGpu2:get(1):add(deConv4);
--1x64x6x63x63 =x2
...
convGpu1:get(1):add(join5);
convGpu1:get(1):add(convGpu6);
