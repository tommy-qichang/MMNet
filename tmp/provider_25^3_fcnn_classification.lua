...
local datasetName = 'provider_voxel_fcnn_classification';
...
function Provider:load()
    ...
    local stamp = '1205_fcnn_classify';
    ...
    self.dataset.trainData.label = trLabel.trLabel:permute(2,1):float();
    ...
    self.dataset.testData.label = teLabel.teLabel:permute(2,1):float();
