...
function Provider:load()
    ...
    local teNegDataPath = 'preprocessing/clean_data/patch_test_neg_'..stamp..'.mat';
    local tePosDataPath = 'preprocessing/clean_data/patch_test_pos_'..stamp..'.mat';
...
--        trainData :
--        {
--        data : FloatTensor - size: 32212x1x25x25x25
--        std : 89.4306610207
--        mean : 91.241684551844
--        labels : DoubleTensor - size: 32212
--        }
--        allTeNegData : ByteTensor - size: 326482x1x25x25x25
--        allTrPosData : ByteTensor - size: 16106x1x25x25x25
--        testData :
--        {
--        data : FloatTensor - size: 330491x1x25x25x25
--        std : 89.4306610207
--        mean : 91.241684551844
--        labels : DoubleTensor - size: 330491
--        }
--        allTePosData : ByteTensor - size: 4009x1x25x25x25
--        allTrNegData : ByteTensor - size: 1246452x1x25x25x25
--    }
--}
...
--        trainData :
--        {
--        data : FloatTensor - size: 33788x1x25x25x25
--        std : 89.124464120742
--        mean : 91.388817030425
--        labels : DoubleTensor - size: 33788
--        }
--        allTeNegData : ByteTensor - size: 303897x1x25x25x25
--        allTrPosData : ByteTensor - size: 16894x1x25x25x25
--        testData :
--        {
--        data : FloatTensor - size: 307118x1x25x25x25
--        std : 89.124464120742
--        mean : 91.388817030425
--        labels : DoubleTensor - size: 307118
--        }
--        allTePosData : ByteTensor - size: 3221x1x25x25x25
--        allTrNegData : ByteTensor - size: 1269037x1x25x25x25
--        }
--    }
